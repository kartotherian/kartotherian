...
function validateZoom(zoom, source) {
...
function validateScale(scale, source) {
    if (scale !== undefined) {
        if (!source.scales) {
...
function requestHandler(req, res, next) {
    ...
    return BBPromise.try(function () {
        ...
        z = validateZoom(req.params.z, source);
        scale = validateScale(req.params.scale, source);

        isStatic = req.params.w !== undefined || req.params.h !== undefined;

        if (isStatic) {
            return imager.render(source, format, req, z, scale, handler);
        } else {
...
module.exports.init = function(opts) {
    ...
    opts.reportRequestError = reportRequestError;
    marker.init(opts, router);
