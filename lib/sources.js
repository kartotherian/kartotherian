        ...
        .then(function (variables) {
            ...
            return core.mapSequentialAsync(self.sources, function (src, key) {
                ...
                if (core.checkType(src, 'pathname', 'object')) {
                    src.uri.pathname = self._resolveValue(src.pathname);
                }
                if (src.xml) {
...
Sources.prototype._localOrExternalDataAsync = function(values, rootDir, name) {
    var self = this;
    return BBPromise.try(function () {
        ...
        values = _.map(values, function (value) {
            if (typeof value === 'string') {
                var path = pathLib.resolve(rootDir, value);
