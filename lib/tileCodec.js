...
Tile.Value._readField = function (tag, obj, pbf) {
    ...
    obj.tag = tag;
    switch (tag) {
        case 1: obj.value = pbf.readString(); break;
        case 2: obj.value = pbf.readFloat(); break;
        case 3: obj.value = pbf.readDouble(); break;
        case 4: obj.value = pbf.readVarint(true); break;
        case 5: obj.value = pbf.readVarint(); break;
        case 6: obj.value = pbf.readSVarint(); break;
        case 7: obj.value = pbf.readBoolean(); break;
...
Tile.Value.write = function (obj, pbf) {
    switch (obj.tag){
        case 1: pbf.writeStringField(1, obj.value); break;
        case 2: pbf.writeFloatField(2, obj.value); break;
        case 3: pbf.writeDoubleField(3, obj.value); break;
        case 4: pbf.writeVarintField(4, obj.value); break;
        case 5: pbf.writeVarintField(5, obj.value); break;
        case 6: pbf.writeSVarintField(6, obj.value); break;
        case 7: pbf.writeBooleanField(7, obj.value); break;
        default: throw new Error('Unexpected value tag #' + obj.tag);
    }
};
...
Tile.Feature._readField = function (tag, obj, pbf) {
    switch (tag) {
        case 1: obj.id = pbf.readVarint(); break;
        case 2: obj.tags = pbf.readPackedVarint(); break;
        case 3: obj.type = pbf.readVarint(); break;
        case 4: obj.geometry = pbf.readPackedVarint(); break;
...
Tile.Layer._readField = function (tag, obj, pbf) {
    switch (tag) {
        case 15: obj.version = pbf.readVarint(); break;
        case 1: obj.name = pbf.readString(); break;
        case 2: obj.features.push(Tile.Feature.read(pbf, pbf.readVarint() + pbf.pos)); break;
        case 3: obj.keys.push(pbf.readString()); break;
        case 4: obj.values.push(Tile.Value.read(pbf, pbf.readVarint() + pbf.pos)); break;
        case 5: obj.extent = pbf.readVarint(); break;
