...
core.indexToXY = function indexToXY(index) {
    ...
    let low = index % 67108864,  // 2 ^ 26
        high = Math.floor(index / 67108864);
    return [compactEven26(high) * 8192 + compactEven26(low),
        compactEven26(high >> 1) * 8192 + compactEven26(low >> 1)];
};
