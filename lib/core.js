 ...
 */
module.exports.init = function(rootDir, npmResolver) {
    _rootDir = rootDir;
 ...
 */
module.exports.getAppRootDir = function(moduleName) {
...
module.exports.xyToIndex = function(x, y) {
    if (!module.exports.isValidCoordinate(x) || !module.exports.isValidCoordinate(y)) {
...
module.exports.safeLoadAndRegister = function(libs, tilelive, log) {
    ...
    _.each(libs, function(libname) {
        ...
        try {
            ...
            log('info', util.format('Failed to load %s: %s ', libname, err.message));
