...
core.registerTileliveModule = function registerTileliveModule(module) {
    ...
    if (!core._registeredModules[module]) {
        core._registeredModules[module] = true;
...
core.uncompressAsync = Promise.method(function (data, headers) {
    if (data && data.length) {
...
core.compressPbfAsync = function(result) {
