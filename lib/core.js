 ...
 *
 */
module.exports.init = function init(app, packageConfig, rootDir, npmLoader, npmResolver) {
    _app = app;
 ...
 * Returns the root dir of the app, as specified in the init() call
 */
module.exports.loadNpmModules = function loadNpmModules(pkgConfigList) {
...
module.exports.getAppConfiguration = function getAppConfiguration() {
