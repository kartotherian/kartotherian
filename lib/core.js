...
var _conf, _rootDir, _npmResolver, _sources;
 ...
 * core.init(app.conf, app.logger, require('path').resolve(__dirname, '..'), function (module) { return require.resolve(module); }, require('tilelive'));
 */
module.exports.init = function init(app, rootDir, npmResolver, tilelive, mapnik) {
    _conf = app.conf;
    _rootDir = rootDir;
 ...
 */
module.exports.log = function log(group, message) {
 ...
 */
module.exports.errToStr = function errToStr(err) {
 ...
 */
module.exports.resolveModule = function resolveModule(moduleName) {
 ...
 */
module.exports.getAppRootDir = function getAppRootDir() {
 ...
 */
module.exports.throwNoTile = function throwNoTile() {
 ...
 */
module.exports.isNoTileError = function isNoTileError(err) {
 ...
 * @returns {*}
 */
module.exports.normalizeUri = function normalizeUri(uri) {
 ...
 */
module.exports.isValidCoordinate = function isValidCoordinate(val, zoom) {
    if (zoom === undefined) {
...
module.exports.validateZoom = function validateZoom(zoom, source) {
...
module.exports.validateScale = function validateScale(scale, source) {
    if (scale !== undefined) {
        if (!source.scales) {
...
module.exports.reportError = function reportError(errReporterFunc, err) {
    try {
        errReporterFunc(err);
    } catch (e2) {
...
module.exports.reportRequestError = function reportRequestError(err, res) {
...
module.exports.setSources = function setSources(sources) {
    _sources = sources;
};

module.exports.getSources = function getSources() {
    if (!_sources) {
...
module.exports.getPublicSource = function getPublicSource(srcId) {
 ...
 * @param dataHeaders
 */
module.exports.setResponseHeaders = function setResponseHeaders(res, source, dataHeaders) {
    if (_conf.defaultHeaders) res.set(_conf.defaultHeaders);
    if (source && source.defaultHeaders) res.set(source.defaultHeaders);
    if (dataHeaders) res.set(dataHeaders);
    if (_conf.overrideHeaders) res.set(_conf.overrideHeaders);
