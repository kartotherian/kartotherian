...
function loadConfigurationAsync(app) {
    ...
    return confSource.then(function(conf) {
        ...
        mapnik.register_fonts(util.getModulePath('mapbox-studio-pro-fonts'), {recurse: true});
        mapnik.register_fonts(util.getModulePath('mapbox-studio-default-fonts'), {recurse: true});
